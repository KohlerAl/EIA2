...
(function (L07_Household) {
    ...
    L07_Household.generateContent = generateContent;
    ...
    L07_Household.createContent = createContent;
    function createSlider(_parent, _name, _box, _unit) {
        ...
        _box.addEventListener("click", L07_Household.enableSlider);
        span2.innerHTML = "5";
    ...
    function createRadio(_items, _category) {
        ...
        for (let item of _items) {
            ...
            radio.id = item.name;
            radio.addEventListener("click", L07_Household.enableRadio);
            let br = document.createElement("br");
            let label = document.createElement("label");
            label.textContent = item.name;
            label.htmlFor = item.name;
...
})(L07_Household || (L07_Household = {}));
//# sourceMappingURL=GenerateContentL07.js.map