...
(function (L07_Household) {
    ...
    async function handleLoad(_event) {
        ...
        let answer = await fetch("DetailL07.json");
        let offers = await answer.text();
        let detail = JSON.parse(offers);
        L07_Household.generateContent(data);
        L07_Household.createContent(detail);
    ...
    L07_Household.enableSlider = enableSlider;
    ...
    L07_Household.enableRadio = enableRadio;
...
//# sourceMappingURL=HaushaltshilfeL07.js.map