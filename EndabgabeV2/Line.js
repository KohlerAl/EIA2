...
(function (EIA2_EndabgabeV2) {
    class Line extends EIA2_EndabgabeV2.Form {
        constructor(_info) {
            if (_info)
                super(_info);
            else
                super();
            this.size = new EIA2_EndabgabeV2.Vector(0, 100);
            this.type = "Line";
        }
        draw() {
            ...
            EIA2_EndabgabeV2.crc2.moveTo(0, 0 - this.size.y / 2);
