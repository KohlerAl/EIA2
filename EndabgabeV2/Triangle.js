...
(function (EIA2_EndabgabeV2) {
    class Triangle extends EIA2_EndabgabeV2.Form {
        constructor(_info) {
            if (_info)
                super(_info);
            else
        ...
        draw() {
            ...
            EIA2_EndabgabeV2.crc2.moveTo(0 - this.size.x / 2, 0 + this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineTo(0 + this.size.x / 2, 0 + this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineTo(0, 0 - this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineTo(0 - this.size.x / 2, 0 + this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineJoin = "round";
            super.draw();
    ...
    EIA2_EndabgabeV2.Triangle = Triangle;
