...
(function (EIA2_EndabgabeV2) {
    class Square extends EIA2_EndabgabeV2.Form {
        constructor(_info) {
            if (_info)
                super(_info);
            else
        ...
        draw() {
            ...
            EIA2_EndabgabeV2.crc2.moveTo(this.size.x / 2, this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineTo(this.size.x / 2, -this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineTo(-this.size.x / 2, -this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineTo(-this.size.x / 2, this.size.y / 2);
            EIA2_EndabgabeV2.crc2.lineTo(this.size.x / 2, this.size.y / 2);
            super.draw();
    ...
    EIA2_EndabgabeV2.Square = Square;
