namespace L02_Memory {
    ...
    function startTimer(_length: number, _arrayMixed: string[], _sequenceOriginal: string): void {
        ...
        let timer: number = Number(startDuration.value); //timer = Wie lange sollen die Karten zu Beginn des Spiels angezeigt werden 
        let y: number = Number(duration.value); // y = Gesamtdauer des Spiels 
        ...
        function startGame(_time: number): void {
            ...
            var i: NodeJS.Timeout = setInterval(function (): void {
